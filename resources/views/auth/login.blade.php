                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="{{ URL::asset('web_assets/images/logo-light.svg')}}" alt="" height="60">
                            </a>
                        </div>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign in to continue to Happy Habits.</p>
                            </div>
                            <div class="p-2 mt-4">
...
@endsection
@section('script')
<script src="{{ URL::asset('web_assets/libs/particles.js/particles.js') }}"></script>
<script src="{{ URL::asset('web_assets/js/pages/particles.app.js') }}"></script>
<script src="{{ URL::asset('web_assets/js/pages/password-addon.init.js') }}"></script>
